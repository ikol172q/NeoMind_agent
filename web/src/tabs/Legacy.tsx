...
export function LegacyTab({ projectId, onJumpToChat, digestFocus }: Props) {
  ...
  return (
    ...
    >
      <div className="px-3 py-2 text-[11px] text-[var(--color-dim)] flex items-center gap-2 border-b border-[var(--color-border)] bg-[var(--color-panel)]">
        <span className="text-[var(--color-amber)] uppercase tracking-wider text-[10px]">Legacy view</span>
        <span>·</span>
        <span>Old widget grid. Lattice (information distillation) is now the primary view in <code>Research</code>.</span>
      </div>
