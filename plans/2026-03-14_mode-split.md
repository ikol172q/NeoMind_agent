# Plan: Split localuser Agent into Chat + Coding Modes
...
| Claude CLI Tool | localuser Implementation |
|-----------------|------------------------|
...
alias ikol-chat="cd ~/Desktop/localuser_agent && source .venv/bin/activate && python3 main.py --mode chat"
alias ikol-code="cd ~/Desktop/localuser_agent && source .venv/bin/activate && python3 main.py --mode coding"
```
