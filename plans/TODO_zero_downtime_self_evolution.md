...
- [ ] **User creates a second bot via @BotFather** → `@your_neomind_test_bot` or similar
...
- [ ] **`~/.config/neomind-tester/telethon.env`**: add `TG_CANARY_BOT_USERNAME=@your_neomind_test_bot`
...
1. **Canary bot token**: willing to create `@your_neomind_test_bot` via @BotFather?
