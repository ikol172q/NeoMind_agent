...
**Date:** 2026-03-15
**Status:** Done
**Goal:** Allow user to use models from multiple API providers (DeepSeek, z.ai) with seamless switching via `/switch`.

---

## Problem

user was hardcoded to DeepSeek — single API key, single base URL, single set of model limits. Adding z.ai's GLM-5 (or any future provider) required touching dozens of places.
