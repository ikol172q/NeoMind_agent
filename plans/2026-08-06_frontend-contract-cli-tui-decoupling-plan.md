...
**Date:** 2026-08-06  
**Status:** PHASE 4 REPL TURN MIGRATED AND DEFAULT (2026-08-16) — remaining Phase 4 work is save/load behind the store port and the fleet facade; **Phase 5 (Telegram) is the next phase.** §11 is the
