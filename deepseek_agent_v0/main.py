...
# This file is deprecated - use the package directly: ikol1729-agent or python -m ikol1729_agent
...
warnings.warn(
    ...
    "Use 'ikol1729-agent' command or 'python -m ikol1729_agent' instead.",
    DeprecationWarning,
    stacklevel=2
)
