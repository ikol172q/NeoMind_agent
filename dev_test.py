#!/usr/bin/env python3
"""
Dev test script for localuser-agent.
...
def run_tests():
    ...
    print("localuser-agent Development Test")
    print("=" * 60)
    ...
    if required_ok:
        ...
        print("  localuser-agent                    # If installed")
        print("  python -m localuser_agent          # Module execution")
