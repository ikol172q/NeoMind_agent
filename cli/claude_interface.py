"""
Claude CLI-like interface for localuser agent.
...
class ConversationManager:
    """Save / load conversations to ~/.localuser/conversations/."""

    def __init__(self):
        self.base_dir = Path.home() / ".localuser" / "conversations"
...
class ClaudeInterface:
    ...
    def display_welcome(self):
        if self.console:
            ...
            self.console.print()
            self.console.print(
                f"[bold cyan]localuser agent[/bold cyan]  "
                f"[dim]v0.1.0[/dim]"
            )
            self.console.print(
    ...
    def run(self):
        ...
        history_path = Path.home() / ".localuser" / "history"
