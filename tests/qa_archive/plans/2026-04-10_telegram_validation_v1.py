...
E_SCENARIOS: List[Scenario] = [
    ...
    ("E05", "/persona list", 15,
        ["价值", "增长", "contrarian", "Value", "Growth", "Contrarian",
         "Investor", "persona"], "E"),
    ("E06", "列出所有可用的投资人格", 60,
        ["价值", "增长", "contrarian", "Value", "Growth", "Contrarian",
         "persona", "Investor"], "E"),
...
C_SCENARIOS: List[Scenario] = [
    ...
    ("C04", "如果股价涨到 300 我赚多少", 90,
        ["哪个", "什么股票", "没有上下文", "请告诉", "clarify",
         "股票代码", "哪只", "名称", "告诉我", "需要知道",
         "是什么", "具体"], "C"),
    ("C05", "今天天气不错", 45,
        ["天气", "weather", "好", "nice", "不错", "是的",
         "同感", "确实", "哈哈", "聊"], "C"),
...
X_SCENARIOS: List[Scenario] = [
    ...
    ("X07", "/model nonexistent-model-xxx", 15,
        ["not found", "invalid", "unknown", "available",
         "未知", "未找到", "无效", "查看", "模型"], "X"),
    ("X08", "🚀🚀🚀 你好", 30,
        ["你好", "hello", "🚀", "?"], "X"),
